...
mod_sidebar_ui <- function(id) {
  ...
  tagList(
    ...
    conditionalPanel(
      condition = "input.tabs == 'NDVIexplorerTab' && input.ndvisubtabs == 'NDVItsTab'",
    ...
    conditionalPanel(
      condition = "input.tabs == 'NDVIexplorerTab' && input.ndvisubtabs == 'LCexplorerTab'",
    ...
    # Burned Area Time Series and Explorer page-specific buttons
    conditionalPanel(
      condition = "input.tabs == 'BAexplorerTab' && input.basubtabs == 'BAtimeseries'",
      div(actionButton("generate_ba_ts_figures", "Generate Figure", class = "action_button"))
    ),
    conditionalPanel(
      condition = "input.tabs == 'BAexplorerTab' && input.basubtabs == 'BAmapexplorer'",
